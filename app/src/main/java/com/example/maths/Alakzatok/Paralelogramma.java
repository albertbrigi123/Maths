...
public class Paralelogramma extends AppCompatActivity {
    ImageButton closeBtn;
    Button torol,szamol;
    EditText ertek1,ertek2,ertek3;
    TextView kerulet,terulet;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_paralelogramma);
